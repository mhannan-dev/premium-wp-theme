				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						<div class="single_jobs white-bg d-flex justify-content-between">
							<div class="jobs_left d-flex align-items-center">
								<div class="thumb">
									<img src="<?php echo esc_url(get_template_directory_uri() . '/img/svg_icon/2.svg'); ?>" alt="">
								</div>
								<div class="jobs_conetent">
									<a href="job_details.html">
				...
				<div class="col-lg-12">
					<div class="candidate_active owl-carousel">
						<div class="single_candidates text-center">
							<div class="thumb">
								<img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/img/candiateds/1.png'); ?> " alt="">
							</div>
							<a href="#">
						...
						<div class="single_candidates text-center">
							<div class="thumb">
								<img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/img/candiateds/2.png'); ?> " alt="">
							</div>
							<a href="#">
								<h4>Markary Jondon</h4>
							</a>
						...
						<div class="single_candidates text-center">
							<div class="thumb">
								<img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/img/candiateds/3.png'); ?> " alt="">
							</div>
							<a href="#">
								<h4>Markary Jondon</h4>
							</a>
						...
						<div class="single_candidates text-center">
							<div class="thumb">
								<img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/img/candiateds/5.png'); ?> " alt="">
							</div>
							<a href="#">
								<h4>Markary Jondon</h4>
							</a>
						...
						<div class="single_candidates text-center">
							<div class="thumb">
								<img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/img/candiateds/6.png'); ?> " alt="">
							</div>
							<a href="#">
								<h4>Markary Jondon</h4>
							</a>
							...
							<div class="row">
								<div class="col-lg-11">
									<div class="single_testmonial d-flex align-items-center">
										<div class="thumb">
											<img src="<?php echo esc_url(get_template_directory_uri() . '/img/testmonial/author.png'); ?>" alt="">
